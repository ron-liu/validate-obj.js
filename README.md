This library `validate-obj` was built mainly for validation for REST APIs. Since then, there are many other better ways can achieve the same goal like `swagger` or `graphql`, I obsolete this library, please do NOT use it any more.
